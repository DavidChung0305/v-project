...
const { id } = useParams()
  ...
  */
  ...
  return (
  <div className="pl-3">
    <ChannelInfo id={channels?.channelId}  title={channels?.channelTitle} image={channels?.channelImage} SVnumber={channels?.SVnumber} introduction={channels?.channelDescription} />
