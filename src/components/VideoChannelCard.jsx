const VideoChannelCard = ({ image, title, sNumber, onClick}) =>{
  ...
  <div className="flex w-[450px] mt-3 cursor-pointer" onClick={onClick}>
    ...
    <i className="fa-regular fa-bell w-[120px] h-[32px] text-xl pl-[8px] py-0.5  ml-[70px] mt-[30px] border border-solid  border-white rounded-lg  hover:bg-sidebarButtonColor hover:scale-105 duration-200"></i>
</div>
  )
}
