  ...
  return(
    <div className="flex mt-4 border-b border-solid border-sidebarBorder pb-2">
      ...
      <div className="pl-6">
        ...
        <p className=" text-gray-400 text-sm">{SVnumber}</p>
        <div className="flex mb-2">
          <p className="text-sm text-gray-400 mt-2 w-[300px] whitespace-nowrap overflow-hidden text-ellipsis">{introduction}</p>
